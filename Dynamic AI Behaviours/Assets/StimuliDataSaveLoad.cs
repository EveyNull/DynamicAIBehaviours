...
public class StimuliDataSaveLoad : MonoBehaviour
{
    ...
    private IEnumerator SaveCoroutine()
    {
        ...
        yield return FileBrowser.WaitForSaveDialog(FileBrowser.PickMode.Folders);

        if(FileBrowser.Success)
        {
            string filePath = FileBrowserHelpers.CreateFileInDirectory(FileBrowser.Result[0], "StimuliNNData.txt");
